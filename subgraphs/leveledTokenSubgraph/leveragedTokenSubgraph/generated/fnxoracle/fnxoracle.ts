...
export class fnxoracle__getAssetAndUnderlyingPriceResult {
  value0: BigInt;
  value1: BigInt;
...
export class fnxoracle extends ethereum.SmartContract {
  static bind(address: Address): fnxoracle {
    return new fnxoracle("fnxoracle", address);
  }

  getAssetAndUnderlyingPrice(
    asset: Address,
    underlying: BigInt
  ): fnxoracle__getAssetAndUnderlyingPriceResult {
    ...
    return new fnxoracle__getAssetAndUnderlyingPriceResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getAssetAndUnderlyingPrice(
    asset: Address,
    underlying: BigInt
  ): ethereum.CallResult<fnxoracle__getAssetAndUnderlyingPriceResult> {
    ...
    return ethereum.CallResult.fromValue(
      new fnxoracle__getAssetAndUnderlyingPriceResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
