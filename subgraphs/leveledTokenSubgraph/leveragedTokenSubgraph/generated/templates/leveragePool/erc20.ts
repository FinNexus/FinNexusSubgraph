...
export class erc20 extends ethereum.SmartContract {
  ...
  APPROVE_WITH_AUTHORIZATION_TYPEHASH(): Bytes {
    let result = super.call(
      "APPROVE_WITH_AUTHORIZATION_TYPEHASH",
      "APPROVE_WITH_AUTHORIZATION_TYPEHASH():(bytes32)",
      []
    );
  ...
  try_APPROVE_WITH_AUTHORIZATION_TYPEHASH(): ethereum.CallResult<Bytes> {
  ...
  DECREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH(): Bytes {
    let result = super.call(
      "DECREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH",
      "DECREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH():(bytes32)",
      []
    );
  ...
  try_DECREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH(): ethereum.CallResult<
    Bytes
  > {
    let result = super.tryCall(
      "DECREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH",
  ...
  INCREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH(): Bytes {
    let result = super.call(
      "INCREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH",
      "INCREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH():(bytes32)",
      []
    );
  ...
  try_INCREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH(): ethereum.CallResult<
    Bytes
  > {
    let result = super.tryCall(
      "INCREASE_ALLOWANCE_WITH_AUTHORIZATION_TYPEHASH",
  ...
  authorizationState(authorizer: Address, nonce: Bytes): i32 {
    let result = super.call(
      "authorizationState",
      "authorizationState(address,bytes32):(uint8)",
      [
...
export class ApproveWithAuthorizationCall extends ethereum.Call {
  get inputs(): ApproveWithAuthorizationCall__Inputs {
    return new ApproveWithAuthorizationCall__Inputs(this);
  }

  get outputs(): ApproveWithAuthorizationCall__Outputs {
    return new ApproveWithAuthorizationCall__Outputs(this);
  }
}

export class ApproveWithAuthorizationCall__Inputs {
  _call: ApproveWithAuthorizationCall;

  constructor(call: ApproveWithAuthorizationCall) {
    this._call = call;
  }
...
export class ApproveWithAuthorizationCall__Outputs {
  _call: ApproveWithAuthorizationCall;
...
export class DecreaseAllowanceWithAuthorizationCall extends ethereum.Call {
  get inputs(): DecreaseAllowanceWithAuthorizationCall__Inputs {
    return new DecreaseAllowanceWithAuthorizationCall__Inputs(this);
  }

  get outputs(): DecreaseAllowanceWithAuthorizationCall__Outputs {
    return new DecreaseAllowanceWithAuthorizationCall__Outputs(this);
  }
}

export class DecreaseAllowanceWithAuthorizationCall__Inputs {
  _call: DecreaseAllowanceWithAuthorizationCall;

  constructor(call: DecreaseAllowanceWithAuthorizationCall) {
    this._call = call;
  }
...
export class DecreaseAllowanceWithAuthorizationCall__Outputs {
  _call: DecreaseAllowanceWithAuthorizationCall;
...
export class IncreaseAllowanceWithAuthorizationCall extends ethereum.Call {
  get inputs(): IncreaseAllowanceWithAuthorizationCall__Inputs {
    return new IncreaseAllowanceWithAuthorizationCall__Inputs(this);
  }

  get outputs(): IncreaseAllowanceWithAuthorizationCall__Outputs {
    return new IncreaseAllowanceWithAuthorizationCall__Outputs(this);
  }
}

export class IncreaseAllowanceWithAuthorizationCall__Inputs {
  _call: IncreaseAllowanceWithAuthorizationCall;

  constructor(call: IncreaseAllowanceWithAuthorizationCall) {
    this._call = call;
  }
...
export class IncreaseAllowanceWithAuthorizationCall__Outputs {
  _call: IncreaseAllowanceWithAuthorizationCall;
