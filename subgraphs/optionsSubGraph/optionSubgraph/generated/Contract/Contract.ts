...
export class Contract__getALLCollateralinfoResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
  value2: Array<BigInt>;
  value3: Array<BigInt>;
...
export class Contract__getInputAmountRangeResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__getPriceRateRangeResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  getALLCollateralinfo(param0: Address): Contract__getALLCollateralinfoResult {
    let result = super.call(
    ...
    return new Contract__getALLCollateralinfoResult(
  ...
  try_getALLCollateralinfo(
    param0: Address
  ): ethereum.CallResult<Contract__getALLCollateralinfoResult> {
    let result = super.tryCall(
      "getALLCollateralinfo",
      "getALLCollateralinfo(address):(uint256[],int256[],uint32[],uint32[])",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Contract__getALLCollateralinfoResult(
  ...
  getInputAmountRange(): Contract__getInputAmountRangeResult {
    let result = super.call(
      "getInputAmountRange",
    ...
    return new Contract__getInputAmountRangeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getInputAmountRange(): ethereum.CallResult<
    Contract__getInputAmountRangeResult
  > {
    let result = super.tryCall(
      "getInputAmountRange",
      "getInputAmountRange():(uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__getInputAmountRangeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getPriceRateRange(): Contract__getPriceRateRangeResult {
    let result = super.call(
      "getPriceRateRange",
    ...
    return new Contract__getPriceRateRangeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPriceRateRange(): ethereum.CallResult<
    Contract__getPriceRateRangeResult
  > {
    let result = super.tryCall(
      "getPriceRateRange",
      "getPriceRateRange():(uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__getPriceRateRangeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
